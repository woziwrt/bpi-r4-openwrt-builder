...
# CONFIG_TARGET_DEVICE_mediatek_filogic_DEVICE_mediatek_mt7987a-rfb is not set
...
# CONFIG_TARGET_DEVICE_mediatek_filogic_DEVICE_mediatek_mt7988a-rfb-mxl86252 is not set
...
CONFIG_MODULE_DEFAULT_wpad-openssl=y
CONFIG_HAS_FPU=y
...
# CONFIG_PACKAGE_airoha-phy-firmware is not set
...
CONFIG_PACKAGE_kmod-mt798x-2p5g-phy=m
...
# CONFIG_PACKAGE_luci-i18n-omcproxy-ga is not set
...
# CONFIG_PACKAGE_luci-i18n-omcproxy-yua is not set
...
# CONFIG_PACKAGE_luci-i18n-statistics-ga is not set
...
# CONFIG_PACKAGE_overlayfs-encryption is not set
# end of Misc
...
# CONFIG_PING_LEGACY_SYMLINKS is not set
...
# CONFIG_PACKAGE_modemmanager-rpcd is not set
